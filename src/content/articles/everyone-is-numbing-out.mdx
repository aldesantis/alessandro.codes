...
- The whole reason for ironic detachment is to build a protective wall between oneself and the world. We *think* we’re building a wall, but we’re really hollowing ourselves out from the inside. Eventually, without really noticing it, there will be nothing left for the wall to defend. There will be no one to find.
