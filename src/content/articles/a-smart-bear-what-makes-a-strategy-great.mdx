...
- The process of strategy *creation* must indeed tackle the complexity of the world, but the *output* of that process is a document that frees everyone else from having to re-solve every puzzle.
...
- If you’re worried someone might leave the company when they hear how scary it is, maybe they *should* leave the company. These *are* the challenges we’re facing together; if they’re not willing to solve them, they need to make space for someone who will relish the challenge.
