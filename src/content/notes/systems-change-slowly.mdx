...
topics:
  - systems-thinking
updatedAt: 2026-07-28T08:35:53.000Z
contentType: notes
---
...
However, it also means that practitioners need to be able to notice small perturbations _before_ they disrupt the system. Otherwise, by the time the problem becomes evident, it will be too late to do anything about it.
