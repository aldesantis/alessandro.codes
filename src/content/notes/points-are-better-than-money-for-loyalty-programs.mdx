...
To use points to the fullest extend, you should consider whether it’s better to [[build-your-loyalty-program-with-tiers-not-balances|Build your loyalty program with tiers, not balances]].

## References

- [[leveraging-the-loyalty-margin-rewards-programs-that-work|Leveraging the Loyalty Margin Rewards Programs That Work]]
