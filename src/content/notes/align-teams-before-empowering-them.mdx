...
The practical elements of team alignment are a clear purpose and output metrics. The team’s #1 responsibility should then be to find and [[focus-on-controllable-input-metrics|Focus on controllable input metrics]]. This allows team to know where they need to go, and lets them figure out how to get there.
