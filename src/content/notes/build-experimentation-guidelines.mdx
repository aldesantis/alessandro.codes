...
aliases:
  ...
  - Build experimentation guidelines are guidelines
permalink: n/build-experimentation-guidelines
status: null
title: Build experimentation guidelines are guidelines
---
Experimentation guidelines allow you to quickly and safely tackle challenges and capitalize on opportunities, and get closer to your shared vision ([[an-operating-cadence-needs-shared-vision|An operating cadence needs shared vision]]).
...
Having experimentation guidelines that follow these traits also allows people to explore ideas from different angles before executing on them (because [[ideas-need-to-be-grappled-with|Ideas need to be grappled with]]).
