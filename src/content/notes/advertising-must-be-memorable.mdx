...
This doesn’t mean that advertising _persuades_ you to buy a product, necessarily—in fact, very few people look at an ad and then buy.

Instead, advertising should reinforce what the brand is/does and where you can buy it. In other words, it [[marketing-must-build-mental-availability|builds mental availability]] by creating a connection between the category and the brand that is being advertised.
