...
- You can build valuable products by taking away pains, or magnifying joys.
...
- The next time you catch someone asking which feature is higher priority without discussing business goals, target users, and their use, that’s your cue to start asking questions.
