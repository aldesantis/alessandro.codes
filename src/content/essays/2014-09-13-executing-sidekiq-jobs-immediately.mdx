...
excerpt: 'Or: How To Save a few bucks when developing your MVP.'
publishedOn: 2014-09-13T00:00:00.000Z
status: evergreen
...
Now you’ll have to set the **DISABLE\_ASYNC** environment variable. If you have the Heroku toolbelt installed, you can execute this command from your project’s root directory:
