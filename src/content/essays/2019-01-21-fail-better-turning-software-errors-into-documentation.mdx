...
excerpt: >-
  The open-source community has done a great job of promoting good documentation
  as a necessary trait for the success of a software project, whether it be a
  utility library, a larger framework or a standalone program.
publishedOn: 2019-01-21T00:00:00.000Z
status: evergreen
