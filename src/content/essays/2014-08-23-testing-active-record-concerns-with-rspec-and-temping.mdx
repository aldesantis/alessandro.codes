...
excerpt: >-
  I won’t even attempt to discuss the utility of concerns. To some people,
  they’re a dangerous way of hiding dependency and just syntactic sugar for
  include/extend. To others, they should be used whenever possible. To me,
  concerns are just a tool. I try not to use them too much, but I don’t freak
  out when I see them either.
publishedOn: 2014-08-23T00:00:00.000Z
status: evergreen
...
For example, let’s test the **mark\_as\_processed!** method:
