...
excerpt: >-
  Traditionally, multi-brand retailers have competed on price, in a race to the
  bottom that has left everyone but the consumer dissatisfied. Is there a better
  way?
permalink: e/multi-brand-retail-value-chain
publish: 'false'
